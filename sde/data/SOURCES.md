...
DACE's starter 547-problem library was generated from the public company-wise CSV files in:
...
Check the upstream repository's current license/terms before redistributing or expanding this dataset, and keep attribution with the data.
